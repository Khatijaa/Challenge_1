...
# YOUR CODE HERE!
average_of_loans = (total_of_all_loans/total_number_of_loans)
print(f"Average number of loans cost is:", round(average_of_loans, 2))
...
remaining_month = loan["remaining_months"]
print("Future value is:", future_value,
      "and remaining months:", remaining_month)
...
# YOUR CODE HERE!
loan["discount_rate"] = .20
discount_rate = loan["discount_rate"]
present_value = future_value / \
    (1 + discount_rate/12) ** remaining_month
print(f"present_value is : {present_value: .2f}")
...
new_loan_remaining_months = new_loan["remaining_months"]
new_loan_future_value = new_loan["future_value"]


def calculate_present_value(new_future_value, new_annual_discount_rate, new_remaining_months):

    new_annual_discount_rate = 0.20
    new_remaining_months = new_loan.get("remaining_months")
    new_future_value = new_loan.get("future_value")

    new_present_value = new_future_value / \
        (1 + new_annual_discount_rate/12) ** new_remaining_months
    return new_present_value


new_loan_present_value = calculate_present_value(
    new_loan_future_value, new_loan_remaining_months, new_loan_annual_discount_rate)
...
for loan_price in loans:
    each_price = loan_price.get("loan_price")
...
# YOUR CODE HERE!
print("Here are all the inepensive loans:", inexpensive_loans)
